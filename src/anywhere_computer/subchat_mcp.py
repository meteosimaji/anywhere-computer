...
INSTRUCTIONS = (
    ...
    'after an explicitly supplied, account-matched generation handoff. The '
    'Plugin HTTP observation mode does not acquire that handoff and exposes '
    'read-only tools; its browser-send mode uses browser_prepared generation. '
