...
| Historical evidence | Dated acceptance records, [execution history](EXECUTION-ROADMAP.md), dated [implementation snapshot](IMPLEMENTATION-STATUS.md) | Do not silently rewrite historical failures as current successes |
